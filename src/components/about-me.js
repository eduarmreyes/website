    ...
    <div className="md:flex justify-center">
      ...
      <div className="my-information w-full md:w-1/2 pt-4 mt-4">
        ...
        <p className="mb-4 leading-normal">
          I am from <a href="https://elsalvador.travel/en/" target="_blank" rel="noopener noreferrer">El Salvador</a>. A nice country with a lot of good things in a tiny amount of earth. It's so tiny that you're able to be at the beach in the morning and have a great old town tour at the afternoon, you could even go to a nice mall at night and be back to your place all in one day.
        </p>
        <p className="mb-4 leading-normal">
