...
const WorkingProcess = ({ author, from, cta_text }) => (
  <section className="bg-grey-lightest">
    <div className="container mx-auto py-8 px-6">
      <h1 className="text-center">My Working Process</h1>
      <h3 className="text-grey-darker text-center mt-6 mb-6">
        As a Front End developer, the way I craft out great websites is as
        follows
      </h3>
      <div className="block sm:flex">
        <div className="flex-1 text-grey-darker text-center bg-teal-dark px-6 py-6 m-2">
          ...
          <p className="mt-4 text-teal-lightest">Design</p>
        </div>
